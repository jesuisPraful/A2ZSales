...
public partial class A2zsalesAngularDbContext : DbContext
{
    public A2zsalesAngularDbContext()
    {
    }

    public A2zsalesAngularDbContext(DbContextOptions<A2zsalesAngularDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        var connectionString = config.GetConnectionString("A2ZSalesDBConnection");
